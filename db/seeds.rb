...
Concert.create(name: "RaveFactory", band: "Octopus", description: "Industrial vibes", artist: "Ocrum",  image: "unsplash.com/img/1")
...
Concert.create(name: "BraveWorld",  band: "Shkoon", description: "Arabian vibes",  artist: "Ameen", image: "unsplash.com/img/2")
